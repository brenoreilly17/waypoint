...
module.exports = async function handler(req, res) {
  ...
  const prompt = `You are Waypoint, a travel planning API. You MUST respond with ONLY a valid JSON object — no text before it, no text after it, no markdown, no backticks, no explanation whatsoever.
